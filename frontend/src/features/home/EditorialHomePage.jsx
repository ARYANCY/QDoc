...
export default function EditorialHomePage({ onNavigate, currentUser, allowedTabs = [] }) {
  ...
  const portals = [
    {
      id: "diagnostic",
      title: "01 / Clinical Checkup Lab",
      subtitle: "Multi-Disease VQC Analysis",
      desc: "Upload biological indicator panels or chest X-rays to run real-time Variational Quantum Classification with feature explainability.",
      badge: "VQC 8-QUBIT",
    ...
    {
      id: "twin",
      title: "02 / 3D Digital Health Twin",
      subtitle: "Longitudinal Biomarker Hologram",
      desc: "Interactive spatial representation of organ systems, systemic risk cascades, and historical biomarker evolution across clinical visits.",
      badge: "HOLOGRAM",
    ...
    {
      id: "early_detection",
      title: "03 / Early Detection Map",
      subtitle: "Phenotypic Risk Cascade",
      desc: "Project multi-year disease likelihood trajectories with clinical risk scoring, organ vulnerability ranking, and preventative interventions.",
      badge: "10-YEAR PROJECTION",
      color: "var(--text-gold)",
      icon: BarChart3,
    },
    {
      id: "doctor_booking",
      title: "04 / Physician Network & Tele-Health",
      subtitle: "Consultations & Video Rooms",
      desc: "Discover verified specialists, schedule virtual appointments, join encrypted consultation rooms, and access signed E-Prescriptions.",
      badge: "DIRECT CARE",
      color: "var(--ink-primary)",
      icon: Stethoscope,
    },
    {
      id: "benchmarks",
      title: "05 / AI & Quantum Benchmarks",
      subtitle: "SOTA Comparative Matrix",
      desc: "Compare VQC quantum models directly against classical baselines (XGBoost, SVM, CNN) across ROC-AUC, latency, and sample efficiency.",
      badge: "SOTA 0.947",
    ...
    {
      id: "compliance",
      title: "06 / SaMD Governance & Audit",
      subtitle: "Regulatory Integrity Ledger",
      desc: "Inspect tamper-evident cryptographic audit logs, clinician override records, and FDA/HIPAA compliance telemetry.",
      badge: "CLASS II SaMD",
      color: "var(--ink-primary)",
      icon: ShieldCheck,
    },
